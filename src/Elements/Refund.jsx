  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-6">
      <div className="max-w-3xl bg-white shadow-lg rounded-lg p-8">
        ...
        <p className="text-gray-600 mb-4">
          Refunds will not be issued for changes of mind after project commencement, delays caused by the client, or third-party service failures. If you wish to request a refund or cancellation, please contact us at <strong>ranjunior05@gmail.com</strong>.
        </p>
